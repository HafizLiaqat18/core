...
<style>
      .whatsapp-float {
    position: fixed;
    bottom: 60px; /* Pehle 20px tha, ab 80px kiya */
    right: 20px;
...
<footer class="footer">
        ...
        <div class="container">
            <div class="row g-4 justify-content-xl-between">
                <div class="col-md-10 col-xl-4">
                    ...
                    <ul class="list list--row social-list">
                        @foreach ($socialIcons as $social)
                            <li>
                                <a href="{{ __($social->data_values->url) }}" target="_blank" class="t-link social-list__icon"
                ...
                <div class="col-md-4 col-xl-3">
                        ...
                        @foreach ($pages as $page)
                            <li>
                                <a href="{{ route('pages', $page->slug) }}"
                                    class="t-link t-link--base text--white d-inline-block sm-text">{{ __($page->name) }}</a>
                            </li>
                        @endforeach
                        <li>
                    ...
                    <a href="https://chat.whatsapp.com/JfMKcLNnqqr0COi32SqrV7" class="whatsapp-float" target="_blank">
    ...
    <div class="footer__copyright py-3">
        <p class="mb-0 sm-text text--white text-center">
            ...
            <a href="{{ route('home') }}" class="t-link t-link--base text--base">{{ __(gs('site_name')) }}</a>
        </p>
    </div>
</footer>
